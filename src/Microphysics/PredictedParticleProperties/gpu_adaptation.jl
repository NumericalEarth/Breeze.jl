...
Adapt.adapt_structure(to, x::P3IceIntegralsTable) =
    P3IceIntegralsTable(Adapt.adapt(to, x.fall_speed),
                        Adapt.adapt(to, x.deposition),
...
Oceananigans.Architectures.on_architecture(arch, x::P3IceIntegralsTable) =
    P3IceIntegralsTable(on_architecture(arch, x.fall_speed),
                        on_architecture(arch, x.deposition),
...
Adapt.adapt_structure(to, x::P3RainIceCollectionTable) =
    P3RainIceCollectionTable(Adapt.adapt(to, x.mass),
                             Adapt.adapt(to, x.number),
                             Adapt.adapt(to, x.sixth_moment))

Oceananigans.Architectures.on_architecture(arch, x::P3RainIceCollectionTable) =
    P3RainIceCollectionTable(on_architecture(arch, x.mass),
                             on_architecture(arch, x.number),
                             on_architecture(arch, x.sixth_moment))
