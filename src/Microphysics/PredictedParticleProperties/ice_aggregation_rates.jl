...
@inline function ice_aggregation_rate(p3, qⁱ, nⁱ, T, Fᶠ, ρᶠ, ρ, qʷⁱ = zero(typeof(qⁱ)),
    ...
    ℂᵃᵍᵍʳ₁ = parameters.maximum_aggregation_efficiency
    ℂᵃᵍᵍʳ₂ = parameters.minimum_aggregation_efficiency
    ℂᵃᵍᵍʳ₃ = parameters.aggregation_efficiency_ramp_start_temperature
    ℂᵃᵍᵍʳ₄ = parameters.aggregation_efficiency_ramp_end_temperature
    ℂᵃᵍᵍʳ₅ = parameters.minimum_aggregation_rime_fraction
    ℂᵃᵍᵍʳ₆ = parameters.maximum_aggregation_rime_fraction
