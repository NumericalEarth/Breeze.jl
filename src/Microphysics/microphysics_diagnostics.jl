...
```jldoctest rh
using Breeze
grid = RectilinearGrid(size=128, z=(0, 1e3), topology=(Flat, Flat, Bounded))
...
├── status: time=0.0
└── data: 1×1×134 OffsetArray(::Array{Float64, 3}, 1:1, 1:1, -2:131) with eltype Float64 with indices 1:1×1:1×-2:131
    └── max=0.353042, min=0.215746, mean=0.277825
```
