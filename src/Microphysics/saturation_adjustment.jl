...
@inline microphysical_velocities(::SaturationAdjustment, μ, name) = nothing
...
@inline function maybe_adjust_thermodynamic_state(i, j, k, 𝒰₀, saturation_adjustment::SA, ρᵣ, microphysical_fields, qᵗ, constants)
