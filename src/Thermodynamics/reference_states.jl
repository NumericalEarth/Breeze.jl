...
function ReferenceState(grid, constants=ThermodynamicConstants(eltype(grid));
    ...
    return materialize_reference_state(grid, constants, surface_pressure, potential_temperature, pˢᵗ,
                                       discrete_hydrostatic_balance,
                                       vapor_mass_fraction, liquid_mass_fraction, ice_mass_fraction)
end

# Homogeneous reference state: a constant `surface_pressure` and a constant or `z`-function
...
function materialize_reference_state(grid, constants, surface_pressure::Number,
...
#####
#
# Array-valued `surface_pressure` and/or `potential_temperature` give each column of an ensemble its
...
materialize_reference_state(grid, constants, surface_pressure::AbstractArray, potential_temperature, pˢᵗ, args...) =
