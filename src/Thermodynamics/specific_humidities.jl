...
@inline dry_air_mass_fraction(q::SpecificHumidities) = 1 - total_specific_humidity(q)

"""
    mixture_gas_constant(q::SpecificHumidities, thermo)
...
"""
@inline function mixture_gas_constant(q::SpecificHumidities, thermo::TC)
...
liquid condensate.
"""
@inline function mixture_heat_capacity(q::SpecificHumidities, thermo::TC)
    qᵈ = dry_air_mass_fraction(q)
    qᵛ = q.vapor
