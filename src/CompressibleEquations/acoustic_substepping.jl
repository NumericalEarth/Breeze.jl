...
#
# `|δτ|` rather than `δτ` makes the sponge a one-sided dissipative regularizer
# in either integration direction. Outside the sponge layer the ramp vanishes
# and the column tridiag is unaffected.
