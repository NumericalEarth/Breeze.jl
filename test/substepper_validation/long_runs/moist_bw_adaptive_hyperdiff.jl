...
const RUN_LABEL = "moist_bw_adaptive_hyperdiff"
...
# Hyperdiffusion: simple constant biharmonic for first probe.
# ν = Δx⁴/(8 timescale) sized for polar Δx=19km, timescale=15d:
# ν = 19000^4/(8*1.3e6) ≈ 1.25e10 m^4/s. Use 1e10.
closure = HorizontalScalarBiharmonicDiffusivity(Float32; ν = 1f10, κ = 1f10)
