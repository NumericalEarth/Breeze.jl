...
@testset "Reactant/Enzyme differentiation - Periodic×Periodic×Bounded topology (3D)" begin
    grid = RectilinearGrid(ReactantState(); size=(3, 3, 3), extent=(1000, 1000, 1000),
