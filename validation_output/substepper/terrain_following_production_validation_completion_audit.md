...
Status: incomplete as of 2026-05-21. Latest production gate:
`pass=16 present=21 fail=21 missing=0 blocked=5`.
...
gate result recorded above: `pass=16 present=21 fail=21 missing=0 blocked=5`.
