...
### AtmosphereModels.AnelasticEquations

```@autodocs
Modules = [Breeze.AtmosphereModels.AnelasticEquations]
Private = false
```

### AtmosphereModels.CompressibleEquations

```@autodocs
Modules = [Breeze.AtmosphereModels.CompressibleEquations]
Private = false
```
