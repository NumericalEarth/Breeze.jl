...
* Mapping to AM fields: `ρe` corresponds to `model.formulation.thermodynamics.energy_density`, `ρqᵗ` to `model.moisture_density`, and `qᵗ` to `model.specific_moisture`.
