...
examples = [
    ...
    Example("Neutral atmospheric boundary layer", "neutral_atmospheric_boundary_layer", true),
    ...
    Example("Rising parcel: adiabatic ascent", "rising_parcels", false),
    Example("Acoustic wave in shear layer", "acoustic_wave", false),
    Example("Cloud formation in prescribed updraft", "kinematic_driver", false),
